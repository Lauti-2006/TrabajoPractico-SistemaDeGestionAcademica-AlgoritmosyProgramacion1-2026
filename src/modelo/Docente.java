...
public class Docente {
	...
	private String normalizarNombreDelDocente(String nombre) {
		// Recortar espacios al inicio y final. Y convertir a todo a minusculas
		String normalizado = nombre.trim().toLowerCase();

		// Dos variables de tipo String, una con caracteres acentuados y otra con los
		// mismo caracteres pero sin acentos,
		...
		// Reemplazar por un espacio " " todo carácter que NO sea una letra de la a a la
		// z, un número del 0 al 9, o un espacio.
		normalizado = normalizado.replaceAll("[^a-z0-9 ]", " ");

		// Reducir múltiples espacios consecutivos a un solo espacio
